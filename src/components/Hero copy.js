...
export function Hero(){
    return(
        ...
        <img 
            ...
            className="btn w-[90px] h-[25px] mt-[30px] ml-[300px] rounded-[15px]
            text-[#ECF0F1] flex items-center justify-center" 
        />
        <h1 className="mt-[130px] ml-[-460px] text-[#344E41] font-bold text-lg">
            Join Us in Making a Difference
        </h1>
        <p className="w-[300px] mt-[170px] ml-[-270px] text-[#344E41] leading-tight text-sm">
